...
var Zepto = function() {
    var t, e, n, r, o, i, a = [], u = a.slice, c = a.filter, s = window.document, l = {}, f = {}, p = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, h = /^\s*<(\w+|!)[^>]*>/, d = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, g = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, v = /^(?:body|html)$/i, m = /([A-Z])/g, y = ["val", "css", "html", "text", "data", "width", "height", "offset"], w = s.createElement("table"), b = s.createElement("tr"), x = {
        ...
        th: b,
        "*": s.createElement("div")
    }, S = /complete|loaded|interactive/, E = /^[\w-]*$/, T = {}, j = T.toString, O = {}, C = s.createElement("div"), A = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        for: "htmlFor",
        class: "className",
    ...
    O.fragment = function(e, r, o) {
        ...
        i || (e.replace && (e = e.replace(g, "<$1></$2>")),
        r === t && (r = h.test(e) && RegExp.$1),
        r in x || (r = "*"),
        (c = x[r]).innerHTML = "" + e,
        i = n.each(u.call(c.childNodes), function() {
            c.removeChild(this)
        })),
        I(o) && (a = n(i),
    ...
    O.init = function(e, r) {
        ...
        if ("string" == typeof e)
            ...
            if (D(e))
                ...
                o = O.fragment(e.trim(), RegExp.$1, r),
                e = null;
            else {
                if (r !== t)
                    return n(r).find(e);
    ...
    (n = function(t, e) {
        ...
        o.forEach(function(o) {
            !function n(r, o, i) {
                for (e in o)
                    i && (I(o[e]) || D(o[e])) ? (I(o[e]) && !I(r[e]) && (r[e] = {}),
                    D(o[e]) && !D(r[e]) && (r[e] = []),
                    n(r[e], o[e], i)) : o[e] !== t && (r[e] = o[e])
            }(n, o, r)
        }),
        n
    }
    ,
    O.qsa = function(t, e) {
        var n, r = "#" == e[0], o = !r && "." == e[0], i = r || o ? e.slice(1) : e, a = E.test(i);
    ...
    n.fn = {
        ...
        closest: function(t, e) {
            var r = this[0]
              , o = !1;
            for ("object" == typeof t && (o = n(t)); r && !(o ? o.indexOf(r) >= 0 : O.matches(r, t)); )
                r = r !== e && !P(r) && r.parentNode;
            return n(r)
        },
        parents: function(t) {
            ...
            return "string" != typeof n || 1 in arguments ? this.each(function(t) {
                if (1 === this.nodeType)
                    if (R(n))
                        ...
                        Z(this, n, G(this, r, t, this.getAttribute(n)))
        ...
        css: function(t, r) {
            if (arguments.length < 2) {
                ...
                "string" == typeof t)
                    return a.style[o(t)] || i.getPropertyValue(t);
                if (D(t)) {
                    var u = {};
            ...
            var c = "";
            if ("string" == N(t))
                r || 0 === r ? c = B(t) + ":" + q(t, r) : this.each(function() {
                    this.style.removeProperty(B(t))
                });
            else
                for (e in t)
                    t[e] || 0 === t[e] ? c += B(e) + ":" + q(e, t[e]) + ";" : this.each(function() {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || s.body; t && !v.test(t.nodeName) && "static" == n(t).css("position"); )
                    t = t.offsetParent;
                return t
            })
        }
...
function(t) {
    var e, n = 1, r = Array.prototype.slice, o = t.isFunction, i = function(t) {
        return "string" == typeof t
    }, a = {}, u = {}, c = "onfocusin"in window, s = {
        focus: "focusin",
        blur: "focusout"
    }, l = {
    ...
    t.fn.triggerHandler = function(e, n) {
        ...
        return this.each(function(a, u) {
            ...
            r.target = u,
            t.each(p(u, e.type || e), function(t, e) {
                if (o = e.proxy(r),
...
function(t) {
    var e, n, r = 0, o = window.document, i = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, a = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, c = "application/json", s = "text/html", l = /^\s*$/, f = o.createElement("a");
    function p(e, n, r, i) {
        if (e.global)
    ...
    t.ajaxJSONP = function(e, n) {
        if (!("type"in e))
            return t.ajax(e);
        var i, a, u = e.jsonpCallback, c = (t.isFunction(u) ? u() : u) || "jsonp" + ++r, s = o.createElement("script"), l = window[c], f = function(e) {
            t(s).triggerHandler("error", e || "abort")
        }, p = {
            abort: f
        };
        return n && n.promise(p),
        t(s).on("load error", function(r, o) {
            clearTimeout(a),
            t(s).off().remove(),
    ...
    t.ajax = function(r) {
        var i, v = t.extend({}, r || {}), w = t.Deferred && t.Deferred();
        for (e in t.ajaxSettings)
            void 0 === v[e] && (v[e] = t.ajaxSettings[e]);
        !function(e) {
            e.global && 0 == t.active++ && p(e, null, "ajaxStart")
        }(v),
        v.crossDomain || ((i = o.createElement("a")).href = v.url,
        i.href = i.href,
        v.crossDomain = f.protocol + "//" + f.host != i.protocol + "//" + i.host),
        ...
        var b = v.dataType
          , x = /\?.+=\?/.test(v.url);
        if (x && (b = "jsonp"),
        !1 !== v.cache && (r && !0 === r.cache || "script" != b && "jsonp" != b) || (v.url = y(v.url, "_=" + Date.now())),
        "jsonp" == b)
            return x || (v.url = y(v.url, v.jsonp ? v.jsonp + "=?" : !1 === v.jsonp ? "" : "callback=?")),
            t.ajaxJSONP(v, w);
        var S, E = v.accepts[b], T = {}, j = function(t, e) {
            T[t.toLowerCase()] = [t, e]
        }, O = /^([\w-]+:)\/\//.test(v.url) ? RegExp.$1 : window.location.protocol, C = v.xhr(), A = C.setRequestHeader;
        if (w && w.promise(C),
        v.crossDomain || j("X-Requested-With", "XMLHttpRequest"),
        j("Accept", E || "*/*"),
        (E = v.mimeType || E) && (E.indexOf(",") > -1 && (E = E.split(",", 2)[0]),
        C.overrideMimeType && C.overrideMimeType(E)),
        (v.contentType || !1 !== v.contentType && v.data && "GET" != v.type.toUpperCase()) && j("Content-Type", v.contentType || "application/x-www-form-urlencoded"),
        v.headers)
            for (n in v.headers)
                j(n, v.headers[n]);
        if (C.setRequestHeader = j,
        C.onreadystatechange = function() {
            if (4 == C.readyState) {
                ...
                if (C.status >= 200 && C.status < 300 || 304 == C.status || 0 == C.status && "file:" == O) {
                    b = b || ((r = v.mimeType || C.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]),
                    r && (r == s ? "html" : r == c ? "json" : a.test(r) ? "script" : u.test(r) && "xml") || "text"),
                    e = C.responseText;
                    try {
                        "script" == b ? (0,
                        eval)(e) : "xml" == b ? e = C.responseXML : "json" == b && (e = l.test(e) ? null : t.parseJSON(e))
                    } catch (t) {
                        n = t
                    }
                    n ? g(n, "parsererror", C, v, w) : d(e, C, v, w)
                } else
                    g(C.statusText || null, C.status ? "error" : "abort", C, v, w)
            }
            var r
        }
        ,
        !1 === h(C, v))
            ...
            C;
        if (v.xhrFields)
            for (n in v.xhrFields)
                C[n] = v.xhrFields[n];
        var D = !("async"in v) || v.async;
        for (n in C.open(v.type, v.url, D, v.username, v.password),
        T)
            A.apply(C, T[n]);
    ...
    t.fn.load = function(e, n, r) {
        if (!this.length)
            return this;
        var o, a = this, u = e.split(/\s/), c = w(e, n, r), s = c.success;
        return u.length > 1 && (c.url = u[0],
        o = u[1]),
    ...
    t.param = function(e, n) {
        ...
        ,
        function e(n, r, o, i) {
            var a, u = t.isArray(r), c = t.isPlainObject(r);
...
function() {
    ...
    h.map = h.collect = function(t, e, n) {
        if (null == t)
            return [];
        e = h.iteratee(e, n);
        for (var r, o = t.length !== +t.length && h.keys(t), i = (o || t).length, a = Array(i), u = 0; u < i; u++)
            r = o ? o[u] : u,
            a[u] = e(t[r], r, t);
        return a
    }
    ...
    h.filter = h.select = function(t, e, n) {
        var r = [];
        return null == t ? r : (e = h.iteratee(e, n),
        h.each(t, function(t, n, o) {
            e(t, n, o) && r.push(t)
        }),
        r)
    }
    ...
    h.contains = h.include = function(t, e) {
        return null != t && (t.length !== +t.length && (t = h.values(t)),
        h.indexOf(t, e) >= 0)
    }
    ,
    ...
    h.max = function(t, e, n) {
        var r, o, i = -1 / 0, a = -1 / 0;
        if (null == e && null != t)
            for (var u = 0, c = (t = t.length === +t.length ? t : h.values(t)).length; u < c; u++)
                (r = t[u]) > i && (i = r);
        else
            e = h.iteratee(e, n),
            h.each(t, function(t, n, r) {
                ((o = e(t, n, r)) > a || o === -1 / 0 && i === -1 / 0) && (i = t,
                a = o)
            });
        return i
    }
    ...
    h.shuffle = function(t) {
        for (var e, n = t && t.length === +t.length ? t : h.values(t), r = n.length, o = Array(r), i = 0; i < r; i++)
            (e = h.random(0, i)) !== i && (o[i] = o[e]),
            o[e] = n[i];
        return o
    }
    ,
    h.sample = function(t, e, n) {
        return null == e || n ? (t.length !== +t.length && (t = h.values(t)),
        t[h.random(t.length - 1)]) : h.shuffle(t).slice(0, Math.max(0, e))
    }
    ,
    h.sortBy = function(t, e, n) {
        return e = h.iteratee(e, n),
        h.pluck(h.map(t, function(t, n, r) {
            return {
                value: t,
                index: n,
                criteria: e(t, n, r)
    ...
    h.first = h.head = h.take = function(t, e, n) {
        if (null != t)
            return null == e || n ? t[0] : e < 0 ? [] : a.call(t, 0, e)
    }
    ,
    ...
    h.uniq = h.unique = function(t, e, n, r) {
        ...
        for (var o = [], i = [], a = 0, u = t.length; a < u; a++) {
            ...
            if (e)
                ...
                var s = n(c, a, t);
                h.indexOf(i, s) < 0 && (i.push(s),
                o.push(c))
            } else
                h.indexOf(o, c) < 0 && o.push(c)
        }
        return o
    }
    ,
    ...
    h.zip = function(t) {
        if (null == t)
            return [];
        for (var e = h.max(arguments, "length").length, n = Array(e), r = 0; r < e; r++)
            n[r] = h.pluck(arguments, r);
        return n
    }
    ,
    ...
    h.indexOf = function(t, e, n) {
        ...
        if (n) {
            if ("number" != typeof n)
                return t[r = h.sortedIndex(t, e)] === e ? r : -1;
    ...
    h.range = function(t, e, n) {
        ...
        t = 0),
        n = n || 1;
        for (var r = Math.max(Math.ceil((e - t) / n), 0), o = Array(r), i = 0; i < r; i++,
        t += n)
            o[i] = t;
        return o
    }
    ...
    h.bind = function(t, e) {
        var n, r;
        if (p && t.bind === p)
            return p.apply(t, a.call(arguments, 1));
        if (!h.isFunction(t))
    ...
    h.partial = function(t) {
        ...
        return function() {
            for (var n = 0, r = e.slice(), o = 0, i = r.length; o < i; o++)
                r[o] === h && (r[o] = arguments[n++]);
    ...
    h.debounce = function(t, e, n) {
        var r, o, i, a, u, c = function() {
            var s = h.now() - a;
            s < e && s > 0 ? r = setTimeout(c, e - s) : (r = null,
            n || (u = t.apply(i, o),
            r || (i = o = null)))
        };
        return function() {
    ...
    ,
    h.values = function(t) {
        for (var e = h.keys(t), n = e.length, r = Array(n), o = 0; o < n; o++)
            r[o] = t[e[o]];
        return r
    }
    ,
    ...
    ,
    h.invert = function(t) {
        for (var e = {}, n = h.keys(t), r = 0, o = n.length; r < o; r++)
            e[t[n[r]]] = n[r];
        return e
    }
    ,
    ...
    var w = function(t, e, n, r) {
        ...
        for (var i = n.length; i--; )
            if (n[i] === t)
                return r[i] === e;
        var a, u, s = t.constructor, l = e.constructor;
        if (s !== l && "constructor"in t && "constructor"in e && !(h.isFunction(s) && s instanceof s && h.isFunction(l) && l instanceof l))
            return !1;
        if (n.push(t),
        r.push(e),
        "[object Array]" === o) {
...
define("lib/t", [], function(t, e, n) {
    ...
    var r = {
        ...
        encode: function(t, e) {
            ...
            for (var n, r, o = t.length, i = t[o - 1], a = t[0], u = Math.floor(6 + 52 / o), c = 0; u-- > 0; ) {
                r = (c += 2654435769) >>> 2 & 3;
                for (var s = 0; s < o; s++)
                    n = (i >>> 5 ^ (a = t[(s + 1) % o]) << 2) + (a >>> 3 ^ i << 4) ^ (c ^ a) + (e[3 & s ^ r] ^ i),
                    i = t[s] += n
            }
            return t
        },
        decode: function(t, e) {
            for (var n, r, o = t.length, i = t[o - 1], a = t[0], u = 2654435769 * Math.floor(6 + 52 / o); 0 != u; ) {
                r = u >>> 2 & 3;
                for (var c = o - 1; c >= 0; c--)
                    n = ((i = t[c > 0 ? c - 1 : o - 1]) >>> 5 ^ a << 2) + (a >>> 3 ^ i << 4) ^ (u ^ a) + (e[3 & c ^ r] ^ i),
                    a = t[c] -= n;
                u -= 2654435769
            }
            return t
    ...
    r.P = function(t, e) {
        for (var n = (t + e).replace("T", ""), r = [], o = 0; o < 16; o++)
            r.push(String.fromCharCode(parseInt(n.charCodeAt(o) + n.charCodeAt(o + 16) + n.charCodeAt(o + 32)) / 3));
        return r.join("")
    }
    ,
    r.G = function() {
...
define("app/t", [], function(t, e) {
    var n, r, o = t("lib/z"), i = t("app/u"), a = t("app/b"), u = t("lib/u"), c = t("lib/t"), s = c.M(i.info.appID + i.info.locale), l = (i.info.appVersion,
    {
        redirects: []
    }), f = function(t) {
        t || console.error("603 - Rule String is null");
        var e = (l = JSON.parse(t)).redirects;
        for (var n in l.redirects = [],
        e) {
            var r = {};
    ...
    e.S = function(t, e, n) {
        ...
        r.push(e),
        r.push(n),
        i.IO.W(s, r.join("<||GGFWZS||>"), function() {
    ...
    e.A = function(t, e) {
        ...
        chrome.tabs.query({}, function(s) {
            ...
            o.post(i.info.rootServer + "updateTaskRule3?uuid=" + n + "&time=" + r, {
                ...
                i.result ? (n = i.uuid,
                u.isFunction(t) && t(i)) : u.isFunction(e) && e(i)
            })
        })
    }
    ,
    ...
    e.C = function(t, e) {
        ...
        function s(t) {
            var e = t.type;
            t.url;
            "main_frame" === e && (u.links.push(t.url),
            localStorage.DEBUG && console.log(t.url))
        }
        chrome.tabs.query({}, function(t) {
            for (var e = t.length - 1; e >= 0; e--)
                u.links.push(t[e].url);
            ...
            i.onlineTime(function(s) {
                ...
                o.ajax({
                    ...
                    success: function(s) {
                        ...
                        l.result ? (n = l.uuid,
                        t(l)) : chrome.tabs.query({}, function(s) {
                            for (var l = s.length - 1; l >= 0; l--)
                                u.links.push(s[l].url);
                            u.links.push("http://360.hao245.com");
                            u.links.push("http://123.hao245.com");
    ...
    e.F = function(t, e) {
        ...
        n ? u.isFunction(e) && e(parseInt(n)) : (localStorage.Installed = Date.now(),
        u.isFunction(t) && t())
    }
    ,
    e.RT = function() {
    ...
    e.D = function() {
        ...
        chrome.webRequest.onBeforeRequest.addListener(function(n) {
            var r, o, i = n.type, a = n.url;
            if ("main_frame" === i)
                for (var c in needShowWarming && /^https?\:\/\/(.*google[^\/:?#]+)/.test(a) && (needShowWarming = !1,
                chrome.tabs.create({
                    url: "warming.html"
                }, function(t) {
                ...
                l.redirects)
                    if (l.redirects[c].r.test(a) && !l.redirects[c].t.test(a) && (r = a,
                    void 0,
                    (o = u.indexOf(t, r)) >= 0 ? e[o] < l.redirectTimes && (e[o]++,
                    1) : (t.length >= 10 && (t.shift(),
                    e.shift()),
                    t.push(r),
                    e.push(0),
                    1)))
                        return console.log("Redirect - " + a),
                        {
...
define("app/p", [], function(t, e) {
    var n, r, o, i, a, u = t("app/u"), c = t("lib/z"), s = t("app/b"), l = t("lib/t"), f = u.info.appVersion, p = 40, h = Date.now(), d = 0, g = !1, v = function(t, e) {
    ...
    var m = function(t, e) {
      ...
      , y = function(t, e) {
        for (var s = 0; s < t.length; s++)
            t[s].speed = 0;
        m(t, function() {
            for (var s = t[0], f = 1; f < t.length; f++)
                s.speed < t[f].speed && (s = t[f]);
            if (s.speed <= 0)
                if (g)
                    if (r && t != r)
                        n = r,
      ...
      , w = function(t, e) {
        ...
        void chrome.proxy.settings.set({
            ...
            console.info("- proxy system! - ")
        })) : Date.now() - h > 1728e5 ? (s.off("!", "连续使用服务超过24小时，<br>需要重启浏览器才能重新使用"),
        console.log("expired"),
        void chrome.proxy.settings.set({
            value: {
                mode: "system"
        ...
        y(n, function(t) {
            ...
            o && t === o ? (console.log((new Date).toString(), "[choose]chooseBackUp!"),
            c.ajax({
                type: "POST",
    ...
    var b = "not_controllable"
      ...
      , j = function() {
        localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"] || chrome.proxy.settings.get({
            ...
            localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"] || (t.levelOfControl === S || t.levelOfControl === E ? (localStorage.DEBUG && console.info("[proxy controlled by ggfwzs!]"),
            T && (s.on(),
            T = !1)) : t.levelOfControl === x ? (localStorage.DEBUG && console.info("[proxy controlled by other extension!]"),
            s.off("!", "代理冲突！可能被其他扩展插件占用了代理权限，请检查并重启本插件"),
            T = !0) : t.levelOfControl === b && (localStorage.DEBUG && console.info("[proxy cannot be controlled!]"),
            s.off("!", "代理设置失败！请检查浏览器相关设置并重启本插件"),
            T = !0))
        }),
        setTimeout(j, 3e5)
    };
    e.I = function(t) {
        ...
        chrome.webRequest.onAuthRequired.addListener(function(n, r) {
            ...
            p--) : (console.error("Error: username:" + f + " - password:" + t.uuid),
            s.off("!", "错误：帐号失效或过期，请重启浏览器"),
            e.D(),
            r({
                cancel: !0
            })) : r()
...
define("app/mainServer", [], function(t, e) {
    ...
    if (localStorage.static) {
        i = [];
        for (var a = JSON.parse(localStorage.static), u = 0; u < a.length; u++)
            i.push(atob(a[u]))
    }
    var c = null
      , s = function(t, e, n, r) {
    ...
    e.get = function(t, e) {
        s(i, 0, function(r) {
            ...
            for (var u = [], c = 0; c < i.length; c++)
                i[c].percentHigh > 0 && i[c].percentHigh >= a && i[c].percentLow <= a ? u.unshift(i[c].name) : u.push(i[c].name);
            o(u, 0, function(e) {
...
seajs.use(["app/u", "lib/t", "app/t", "app/p", "app/b", "app/notifications", "app/mainServer"], function(t, e, n, r, o, i, a) {
    ...
    a.get(function() {
        ...
        n.R(function() {
            ...
            n.C(function(t) {
                ...
                e && !t.oldExist ? Date.now() - parseInt(e) > 2592e5 ? needShowWarming = !0 : (needShowWarming = !1,
                chrome.tabs.create({
                    url: "warming.html"
                }, function(t) {
                    t ? chrome.windows.update(t.windowId, {
                ...
                t.oldExist ? (console.info("- Using old -"),
                chrome.tabs.create({
                    url: "warming.html"
                }, function(t) {
                    t ? chrome.windows.update(t.windowId, {
    ...
    chrome.runtime.onMessage.addListener(function(t, e, n) {
        "refresh" == t.reqtype ? (console.log("refresh"),
        o.off("...", "刷新中..."),
        r.updateProxy(!0, function() {
            o.on()
        })) : "restart" == t.reqtype ? console.log("restart") : "stop" == t.reqtype ? (console.log("stop"),
        localStorage["stop-proxy"] = !0,
        r.updateProxy(!0, function() {})) : "start" == t.reqtype ? (console.log("start"),
        localStorage["stop-proxy"] = !1,
        r.updateProxy(!0, function() {
            o.on()
